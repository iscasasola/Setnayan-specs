...
>
> This file is the **original `0052` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0052_native_apps_delivery/0052_native_apps_delivery.md
> git log --follow -- 0052_native_apps_delivery/0052_native_apps_delivery.md
> ```
>
> ### Newer material still live in this folder
> - [App_Store_Submission_Runbook_2026-06-15.md](App_Store_Submission_Runbook_2026-06-15.md)
>
