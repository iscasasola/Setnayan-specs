...
| Today's Focus | ₱1,499 | **Live** | Assisted planning (the AI planner) |
...
|---|---|---|---|
| AI planner | "Setnayan Concierge" ₱4,999 / 12mo (0016) | **"Today's Focus" ₱1,499**, Live | Renamed + repriced |
...
4. **"Today's Focus" vs "Setnayan Concierge."** The AI planner SKU is **Today's Focus ₱1,499**. But `/for-vendors` advertises a *free* **"Setnayan Concierge"** worth **₱2,499** for every couple a vendor books. Same product with two names + two values, or two different products? Decide and unify.
...
| `0016_step_by_step_plan_builder/0016_step_by_step_plan_builder.md` | Reconciliation banner (Today's Focus ₱1,499 · Concierge-name collision) |
...
- `02_Specifications/18_Concierge_Brain/*` (18 files) — "Setnayan Concierge ₱4,999" → "Today's Focus ₱1,499" **(blocked on contradiction § 3.4 — confirm naming first)**
...
| **Today's Focus** | AI planner | Setnayan Concierge (0016) |
