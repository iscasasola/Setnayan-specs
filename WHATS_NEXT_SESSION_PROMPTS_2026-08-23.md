...
| **W4-A · The four screens a couple lives in** | 🟡 **PARTLY → ✅ DONE ON MERGE OF #4791** (4 PRs: #4771 #4780 #4782 #4791). Its own audit reopened it, and the fourth PR is the reopening rather than an overrun. #4791 closes the colours a class-name sweep could not see, widens the guest name column from 22% to 44% of the table, and makes deleting a saved plan ASK — it was a hard delete with no undo while CLEARING the rebuildable list beside it already confirmed. ⏭ Not taken, deliberately: the budget screen's running total scrolls away where its archetype pins it, its rows are ungrouped and its cards never collapse — small individually, a redesign together, judged a next-stream call. | Opus 5 | medium | 4 |
