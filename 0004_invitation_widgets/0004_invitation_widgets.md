...
>
> This file is the **original `0004` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0004_invitation_widgets/0004_invitation_widgets.md
> git log --follow -- 0004_invitation_widgets/0004_invitation_widgets.md
> ```
>
> ### Newer material still live in this folder
> - [0004_invitation_widgets_result.md](0004_invitation_widgets_result.md)
>
