...
>
> This file is the **original `0047` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0047_style_driven_marketplaces/0047_style_driven_marketplaces.md
> git log --follow -- 0047_style_driven_marketplaces/0047_style_driven_marketplaces.md
> ```
>
