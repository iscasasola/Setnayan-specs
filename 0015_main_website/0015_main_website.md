...
>
> This file is the **original `0015` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0015_main_website/0015_main_website.md
> git log --follow -- 0015_main_website/0015_main_website.md
> ```
>
