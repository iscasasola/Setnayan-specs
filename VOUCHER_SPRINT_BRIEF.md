...
- For pilot: only Today's Focus auto-activates post-approval · other SKUs stay `approved` until V1.x activation hooks
...
| 3 | Admin 3-state action (Approve/Resubmit/Decline) + Today's Focus activation hook + 0028 email templates + ledger write hooks | TBD | blocked on Day 2 |
