...
3. **Officiants + paperwork leave the marketplace** — Ceremony becomes a *venue*; the officiant auto-resolves from it (already shipped — Card 04, 2026-05-29); seminars / license / CENOMAR live in the Today's Focus wizard as tasks.
...
| cfo_seminar · marriage_license_expediting · apostille_dfa_authentication | **Today's Focus wizard** host-tasks. **Retire as categories.** |
...
| honeymoon_planner | Today's Focus wizard — honeymoon-planning host-task (NOT a marketplace tile; Honeymoon tile dropped 2026-05-31) |
...
- **Pre-marriage paperwork** — religious seminars (Pre-Cana, INC/Muslim counseling) ride with the venue; civil docs (marriage license, CFO, apostille/DFA) → Today's Focus wizard host-tasks.
