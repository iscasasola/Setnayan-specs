...
>
> This file is the **original `0050` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0050_venue_directory/0050_venue_directory.md
> git log --follow -- 0050_venue_directory/0050_venue_directory.md
> ```
>
