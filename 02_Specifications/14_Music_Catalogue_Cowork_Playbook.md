...
> - **Cross-cutting product facts** that supersede anything implied here: commission is **0%** (no Setnayan Pay 3%/5%); the AI planner SKU is **"Today's Focus" ₱1,499** (not "Concierge ₱4,999"); **Pakanta is a single SKU ₱2,499** (3-tier collapsed in `lib/v2/sku-catalog-v2.ts`); the customer token wallet (0003) is RETIRED; the live SDE SKU is **₱3,499** (not the ₱24,999 figure used in sister refresh docs).
>
