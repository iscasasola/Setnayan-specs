...
> 🚫 **DOUBLY SUPERSEDED — do not build from this paragraph.** (1) The **server-side compositing + Setnayan master-channel** architecture was deferred out of V1 by [`Live_Studio_Repackaging_2026-07-08.md`](../Live_Studio_Repackaging_2026-07-08.md): the controller composites **client-side in the browser** and the stream goes out through the **couple's own OBS to the couple's own channel** — there is no Setnayan master channel, no Cloudflare Stream SFU, and no server-side recorder in V1. (2) **"Sole delivery" is softened 2026-07-20** to *"YouTube as sole **in-app** delivery; Facebook Live supported via OBS"* — with a mandatory UI warning that Facebook auto-deletes live replays after 30 days (Meta policy eff. 2026-02-19). See [`Live_Studio_Competitive_and_Pricing_2026-07-20.md`](../Live_Studio_Competitive_and_Pricing_2026-07-20.md) § 6. Paragraph kept below for lineage only.
