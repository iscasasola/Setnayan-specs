...
> - **Cross-cutting product facts** unaffected by this doc but worth flagging for readers: commission is **0%**; planner SKU = **"Setnayan AI" ₱1,499**; **Pakanta = single SKU ₱2,499** (the per-wedding song service — distinct from this template-background catalogue); customer token wallet (0003) RETIRED.
>
