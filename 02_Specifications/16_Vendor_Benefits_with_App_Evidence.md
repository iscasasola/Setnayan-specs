...
> - **Vendor Landing Page + Reviews + Verified Badge are LIVE,** not "❌ Not specced" (§1.3): vendor microsites/profiles, `/vendor-dashboard/reviews` + `/admin/reviews` + couple-side review surfaces, and a **FREE verification badge** all ship today (the badge is no longer a paid ₱1,499 SKU).
...
> - **The "no paid vendor services in V1 / free signup at Din launch" monetization stance is RETIRED.** Live vendor pricing: Free ₱0 · Solo ₱999/28d (₱9,999/yr) · Pro ₱2,499/28d (₱24,999/yr) · Enterprise ₱4,999/28d (₱49,999/yr) · Verification **FREE**. **Commission is 0%, ever.** A **vendor token economy is LIVE** (burn-on-answer 1–3 tokens ₱100/200/300 region-banded; 100 free founder tokens). The §5 "TD-1…TD-6 / 14–18 month" ladder and §6 phased pitch are superseded.
