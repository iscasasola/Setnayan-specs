...
> **This doc is HISTORICAL/REFERENCE.** Authoritative current state = the live site (www.setnayan.com) + shipped code (`apps/web` @ `origin/main`) + `AS_BUILT_GROUND_TRUTH_2026-06-07.md`. Deltas found:
> - **Vendor role is NO LONGER deferred to "V2 / Din."** Part 3 ("Vendors do not log into Setnayan in V1", "V2 — Din supplier app") is stale. Vendor self-service is SHIPPED: `/signup?as=vendor` → `account_type='vendor'` → a full `/vendor-dashboard` (24 routes — overview, profile, bookings, messages, services, contracts, repertoire, attributes, marketing, verify, reviews, earnings, payment-options, tokens, team, branches, manpower, etc.). "Din" framing is dead; this IS the live marketplace.
> - **Vendor pricing exists today:** Free ₱0 · Solo ₱999/28d (or ₱9,999/yr) · Pro ₱2,499/28d (or ₱24,999/yr) · Enterprise ₱4,999/28d (or ₱49,999/yr) · Verification badge **FREE**. Commission is **0%, ever** (Setnayan never sits between vendor and couple at checkout).
> - **Vendor token economy is LIVE** (distinct from the retired customer wallet): accepting a couple inquiry burns 1–3 tokens (₱100/200/300, region-banded via `token_burn_bands` / `/admin/token-bands`); 100 free founder tokens on verification; packs 4–100. This replaces the doc's premise that vendors "pay nothing in V1."
...
> - SKU prices throughout Part 1 (Add-ons launcher: LED ₱2,000–8,000, Papic 3-seat ₱1,500 / 5-seat ₱2,500, Pro widget ₱100, AI Highlight ₱2,000, etc.) are the **retired charm-ladder set** — current catalog is in §1 of the ground-truth doc (e.g. Papic is now per-camera — Papic Unli ₱100/cam·day / Papic Ltd ₱30/cam·day, both capped ₱15,000/day; Animated Monogram ₱1,999; planner = "Setnayan AI" ₱3,999 not the Part-1 "Step-by-step plan builder 0016").
> - Coordinator/Stylist still deferred — that part is broadly accurate.
>
> When this body disagrees with the above, **the above wins.**
>
> **➕ 2026-06-29 price refresh** (live-site sync — supersedes any stale prices in the banner above): Setnayan AI **₱3,999** (paid first paywall) · Animated Monogram **₱1,999** · Live Studio — ⚠ BOTH the ₱3,499/day single multicam tier AND the 2026-07-08 device tiers (Mobile ₱1,500 / Desktop ₱2,500) are **RETIRED**; unified 2026-07-25 into ONE SKU `LIVE_STUDIO` **₱2,999/event-day**, no device split, 12-camera ceiling (single-cam livestream FREE) · Pakanta **₱2,499** (one SKU) · Cinematic Reveal **₱1,499** · vendor Pro **₱2,499** / Enterprise **₱4,999** per 28-day · **0% commission · verification FREE** · couple website = free 4-in-1 + ONE **Couple Website PRO ₱1,999** (old separate RSVP / RSVP Pro / Event Website / Editorial Website à-la-carte SKUs retired) · couple tiers **Free ₱0 · Setnayan AI ₱3,999** (Essentials/Complete bundles REMOVED 2026-06-29). Canon: `AS_BUILT_GROUND_TRUTH_2026-06-07.md` § 1 + `Pricing.md` § 00.
