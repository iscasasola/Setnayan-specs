...
> - **The AI layer is not "Kasalan."** "Kasalan AI" / "Ask Kasalan" was never the shipped name. The couple-side AI planner is **"Setnayan AI" ₱3,999** (one purchase, full access). Note the couple-app Setnayan AI *wizard* was further retired in code (the SKU/branding persists on the site); the "I'm stuck" button + 3-layer guidance model described here is design history, not a live surface.
