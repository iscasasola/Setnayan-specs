...
>
> This file is the **original `0021` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0021_couple_dashboard_fully_purchased/0021_couple_dashboard_fully_purchased.md
> git log --follow -- 0021_couple_dashboard_fully_purchased/0021_couple_dashboard_fully_purchased.md
> ```
>
> ### Newer material still live in this folder
> - [0021_ADDENDUM_accordion_bottom_nav_2026-06-15.md](0021_ADDENDUM_accordion_bottom_nav_2026-06-15.md)
>
