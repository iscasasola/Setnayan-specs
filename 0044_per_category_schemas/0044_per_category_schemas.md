...
>
> This file is the **original `0044` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0044_per_category_schemas/0044_per_category_schemas.md
> git log --follow -- 0044_per_category_schemas/0044_per_category_schemas.md
> ```
>
