...
>
> This file is the **original `0037` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0037_event_day_preload/0037_event_day_preload.md
> git log --follow -- 0037_event_day_preload/0037_event_day_preload.md
> ```
>
