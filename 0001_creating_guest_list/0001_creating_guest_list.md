...
>
> This file is the **original `0001` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0001_creating_guest_list/0001_creating_guest_list.md
> git log --follow -- 0001_creating_guest_list/0001_creating_guest_list.md
> ```
>
> ### Newer material still live in this folder
> - [0001_creating_guest_list_result.md](0001_creating_guest_list_result.md)
>
