...
- [x] **Decided:** `claude/todays-one-thing-hero` deleted 2026-05-24 (confirmed stale · superseded by WizardHero) — owner confirmed via "is this the Setnayan AI?" question; remote branch deleted via `git push origin --delete claude/todays-one-thing-hero`
