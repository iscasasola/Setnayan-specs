...
| **Setnayan AI** (AI planner) | ₱1,499, **Live** | **OFF — remove the listing** | Owner: keep it off (aligns with the 2026-06-03 Today's-Focus-retired memory). Flag the live site to drop it. |
...
- **Live site (code repo):** token packs → ₱100; remove Setnayan AI; add AI Video Highlight ₱999; homepage verification → free; vendor-Pro single model; drop 5% line. *(engineering task — not this corpus)*
...
✅ **Resolved 2026-06-04:** Save-the-Date kept · Patiktok per-hour · SDE ₱3,499 · AIVH ₱999 add · Setnayan AI off · token = flat ₱100 + bonus-on-bulk · commit-to-tokens · Papic ₱4,499 pool · verification ₱0.
