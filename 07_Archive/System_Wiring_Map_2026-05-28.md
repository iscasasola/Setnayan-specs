...
**Symptom:** when a pilot couple submits a Setnayan AI ₱1,499 OR any cart item:
...
**Why it matters for pilot:** every paid SKU purchase goes through this flow. The 5-20 family cohort will purchase Setnayan AI + add-ons; if they can't complete payment, pilot revenue + lock/unlock cycle coverage breaks.
...
| Concierge-abuse adminClearFlag/adminConfirmAbuse missing audit_log | `admin/concierge-abuse/actions.ts:77-195` | LOW | Setnayan AI OFF for pilot per CLAUDE.md 2026-05-22 row 3 — feature won't fire in pilot |
