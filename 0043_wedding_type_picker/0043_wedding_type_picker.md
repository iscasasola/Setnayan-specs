...
>
> This file is the **original `0043` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0043_wedding_type_picker/0043_wedding_type_picker.md
> git log --follow -- 0043_wedding_type_picker/0043_wedding_type_picker.md
> ```
>
