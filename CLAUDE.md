...
_(Superseded: the old "Latest handoff → HANDOFF_2026-05-17 · Concierge ₱4,999" pointer — Concierge is retired; the planner SKU is **Setnayan AI ₱1,499**. Commission is **0%**, not 3/5%. See the ground-truth doc.)_
...
> **🚫 SUPERSEDED 2026-06-07 (owner-locked "lock it") — the table below is PRE-RESET, kept for lineage only.** Canonical pricing is now the 4-tier paywall in **`Pricing.md` § 00** + memory **`project_setnayan_pricing_tiers`**: **Free–Explore ₱0 · Setnayan AI ₱3,999 (first paywall) · Essentials ₱12,999 · Complete ₱27,999** (19 paid SKUs · SRP ₱53,981). **Setnayan AI is now PAID** (not the ₱1,499 below, not a free funnel). RSVP now paid ₱2,499 / Pro ₱4,499 · Event Website ₱1,999 · Papic Guests ₱2,999. **Removed:** Indoor Blueprint · Call-Time Escalator · Pro Website (→ Event+Editorial Website) · High Res Archive · both bundles. **Mood Board kept (free).** Three reversals (paid AI + paid Event Website + paid RSVP) gut the live "free to plan / free website" pillars — site-sync PR pending.
