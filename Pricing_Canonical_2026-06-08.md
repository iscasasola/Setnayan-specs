...
*(Open: the screenshot's "Removed (no longer offered)" list was cut off — older SKUs not in the 18 (Today's Focus, Indoor Blueprint, Pakulay, Pro Website, High-Res Archive, Call-Time Escalator) are assumed retired customer-facing; confirm.)*
