...
>
> This file is the **original `0005` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0005_led_background_maker/0005_led_background_maker.md
> git log --follow -- 0005_led_background_maker/0005_led_background_maker.md
> ```
>
> ### Newer material still live in this folder
> - [0005_ffmpeg_lottie_reference.md](0005_ffmpeg_lottie_reference.md)
>
