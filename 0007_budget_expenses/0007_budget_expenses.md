...
>
> This file is the **original `0007` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0007_budget_expenses/0007_budget_expenses.md
> git log --follow -- 0007_budget_expenses/0007_budget_expenses.md
> ```
>
