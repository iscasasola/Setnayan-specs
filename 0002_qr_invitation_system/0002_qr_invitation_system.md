...
>
> This file is the **original `0002` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0002_qr_invitation_system/0002_qr_invitation_system.md
> git log --follow -- 0002_qr_invitation_system/0002_qr_invitation_system.md
> ```
>
> ### Newer material still live in this folder
> - [0002_qr_invitation_system_result.md](0002_qr_invitation_system_result.md)
>
