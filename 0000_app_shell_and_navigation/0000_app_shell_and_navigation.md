...
>
> This file is the **original `0000` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0000_app_shell_and_navigation/0000_app_shell_and_navigation.md
> git log --follow -- 0000_app_shell_and_navigation/0000_app_shell_and_navigation.md
> ```
>
> ### Newer material still live in this folder
> - [0000_ADDENDUM_invite_join_model_2026-06-25.md](0000_ADDENDUM_invite_join_model_2026-06-25.md)
>
