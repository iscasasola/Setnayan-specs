---
iteration_id: 0000_app_shell_and_navigation
iteration_number: 0000
spec_source: 0000_app_shell_and_navigation.md
generated_at: 2026-05-12
status: starter — engineer fills in during implementation
---

# Test Plan — Iteration 0000 — App Shell & Navigation
...
**Companion files in this folder:** `0000_app_shell_and_navigation.md` (spec) · `0000_app_shell_and_navigation.html` (prototype) · `0000_app_shell_and_navigation.docx` (stakeholder doc) · `tests.md` (this file).
...
- [ ] **AC-01.** | Each downstream iteration's .md spec must declare which tab it lives under so the shell knows where to route it.
