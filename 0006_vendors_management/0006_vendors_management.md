...
>
> This file is the **original `0006` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0006_vendors_management/0006_vendors_management.md
> git log --follow -- 0006_vendors_management/0006_vendors_management.md
> ```
>
