...
**Not done (needs owner/DPO/counsel):** editing the live `setnayan.com/privacy` notice (code-repo change + legal disclosure), amending the dossier's SPI/subprocessor claims, or flipping any feature flag.
