...
>
> This file is the **original `0046` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0046_wedding_showcase/0046_wedding_showcase.md
> git log --follow -- 0046_wedding_showcase/0046_wedding_showcase.md
> ```
>
