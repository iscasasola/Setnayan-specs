...
async function step6(h) {
  ...
  {
    const doc = JSON.parse((await page.getAttribute('[data-harness-doc]', 'data-harness-doc')) || 'null');
  ...
  await page.screenshot({ path: `${OUT}/drive-${phone ? 'phone' : 'desk'}-step6.png`, fullPage: false });
