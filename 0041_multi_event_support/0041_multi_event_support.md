...
>
> This file is the **original `0041` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0041_multi_event_support/0041_multi_event_support.md
> git log --follow -- 0041_multi_event_support/0041_multi_event_support.md
> ```
>
