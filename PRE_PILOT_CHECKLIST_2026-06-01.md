...
- [ ] Open `/dashboard/[eventId]` · verify Today's Focus wizard renders (CONCIERGE_ENABLED flag state may hide it depending on V2.1 lock state · expected per pilot scope)
