...
>
> This file is the **original `0016` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0016_step_by_step_plan_builder/0016_step_by_step_plan_builder.md
> git log --follow -- 0016_step_by_step_plan_builder/0016_step_by_step_plan_builder.md
> ```
>
