...
| Live Studio — Mobile (`PANOOD_SYSTEM_MOBILE`) | **₱1,500 / day** (≤3 cams · online-only) — single-cam livestream FREE. ✅ **IN CODE 2026-07-20** (PR #3425 · migration `20270827190298`) — supersedes ₱1,299; the "₱1,500 float is spec-only" note is retired. Provenance: owner's per-service sheet **2026-07-17** (DECISION_LOG 2026-07-17), not 07-18. ⏳ needs `supabase db push` to reach prod |
| Live Studio — Desktop (`PANOOD_SYSTEM`) | **₱2,500 / day** (≤8 cams · offline-capable) — ✅ **IN CODE 2026-07-20** (same PR) — supersedes ₱2,499. ⚠ **Round numbers are deliberate** — the 07-17 sheet re-bases off charm pricing (-1 endings) catalog-wide (Pakanta ₱2,500 · 3D Plan ₱3,000 · Monogram Pro ₱999→₱1,000). **Do NOT charm-correct back to ₱1,499/₱2,499** — a 2026-07-20 pass did and was reverted |
