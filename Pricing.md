...
| Papic — shots | 🔄 **THE ROW THAT WAS HERE DESCRIBED A PRODUCT THAT NO LONGER EXISTS** — per-camera, per-day tiers (Mini ₱30 · Ltd ₱50 · Unli ₱100) with daily caps. That model was retired by the ONE-PRODUCT lock of **2026-08-11** and the row was never updated; it is replaced here, and the old text stays in the lineage banners below. **Shipped model:** one shared pot of shots per event. **Cameras are FREE and UNLIMITED.** **50 shots free on every event.** A photo spends 1 credit; a clip spends 2–8 by length (1–2s=2 · 3s=3 · 4–6s=5 · 7–10s=8). **LADDER — owner 2026-08-26, a SCROLLABLE list of 16 rungs priced against ₱1 = 1 credit, discounted 50% → 77.6% (was 80% at the top until 2026-08-27):** `100 ₱50 · 200 ₱100 · 300 ₱150 · 400 ₱200 · 500 ₱250 · 1,000 ₱500 · 2,000 ₱1,000 · 3,000 ₱1,200 · 4,000 ₱1,600 · 5,000 ₱2,000 · 6,000 ₱2,400 · 7,000 ₱2,800 · 10,000 ₱3,200 · 20,000 ₱5,000 · 30,000 ₱7,500 · 50,000 ₱11,200`. Every rung is additive and repeatable. ⚖ **50,000 MOVED ₱10,000 → ₱11,200 on 2026-08-27 (owner).** It SHALLOWS the discount at the very top (80% → 77.6%) rather than deepening it — his call, applied as given. It is still the cheapest rung per credit (₱0.224 against 30,000's ₱0.25) and still the dearest in absolute pesos, so both rules the ladder guard enforces still hold and **no guard was weakened**. Migration `20271171000513`. ⚖ **40,000 is deliberately ABSENT** — his first table had it at ₱10,000, the same price as 50,000, so nobody could rationally choose it; surfaced rather than silently corrected, and he removed it. ⚠ **NEVER re-type these** — `platform_retail_catalog_v2` is the source, `papic_pass_tiers` holds the shot counts, and `apps/web/tests/db/papic-ladder.expected.ts` is the single pinned expectation both db guards compare against. 🚨 **A rung is THREE places**: the catalog row, the tier row, AND a line in `lib/sku-activation.ts` — a sellable rung missing from that map takes the money and grants **zero** shots, silently. |
