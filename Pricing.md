...
| Thank You (Papic add-on) | **₱2,499** | 249,900 | ACTIVE (flat · repriced 2026-06-29 from ₱1,500) · server-render cost | [0012_papic.md](0012_papic/0012_papic.md) |
| Auto-Recap (couple auto-highlight · Papic add-on) | **₱1,499** | 149,900 | **NEW 2026-07-08** · server-rendered (covers its own render cost) · gate-pending render box | [0012_papic.md](0012_papic/0012_papic.md) |
