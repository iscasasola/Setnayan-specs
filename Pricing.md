...
> **🆕 2026-07-10 PRICING FINALIZATION (owner) — ✅ SHIPPED TO PROD ([PR #3022](https://github.com/iscasasola/setnayan-platform/pull/3022) · migrations `20270712300000` + `20270712300100`).** A full pricing session finalized the couple + vendor sheet below; the DB reprices are **applied to live `platform_retail_catalog_v2` / `vendor_billing_catalog`** and all apps/web display/GEO surfaces reconciled. Full rationale in `DECISION_LOG.md` (2026-07-10 entries). ⚠ The rest of this file (§ 0, §§ 2–8) still shows older figures for lineage — this banner + the DB are canonical. **Strategic frame:** couple side = demand engine (cheap AI + emotional à-la-carte, no couple subscriptions/bundles); vendor side = the recurring revenue. Setnayan AI is deterministic (~99% margin, no cost floor) → priced for adoption.
>
> **COUPLE (event) side — FINAL:**
> | SKU | Final price |
> |---|---|
> | Free (all planning + basic 4-in-1 website + unlimited RSVP + basic Save-the-Date + Custom QR) | ₱0 |
> | Setnayan AI (+ watch-guard) | **₱499 one-time, wedding-anchored** (was per-user ₱499→₱799/28d sub) |
> | Animated Monogram | **₱999** (was ₱1,999) — cross-sell gateway; purge "AI/DALL-E" copy |
> | Cinematic Reveal | **₱999** (was ₱1,499) |
> | `xxx.setnayan.com` subdomain | **₱999 / year** — NEW, SHIPPED as "In build" SKU (`EVENT_SUBDOMAIN`, both couple + vendor). ~₱0 COGS. Billable now as a manual prepaid annual block; remaining gap = **provisioning** (wildcard DNS + subdomain routing), not billing. |
> | Editorial PRO | **₱2,999** (was ₱3,499) |
> | 3D Plan | **₱2,999** (was ₱2,499) |
> | ~~Own `.com` domain~~ | **DROPPED** ("no more") |
> | ~~Events PRO ₱9,999 bundle~~ | **REMOVED** — model stays pure à-la-carte |
> | Couple Website PRO ₱4,999 umbrella | **UNBUNDLED** into à-la-carte Editorial + Reveal |
> | Unchanged (kept at current live state) | Pakanta ₱2,499 · Papic ₱100/₱30 per cam·day (capture caps ₱9,000 Ltd / ₱15,000 Unli · owner 2026-07-11, PR #3112) · Live Studio ₱1,299/₱2,499 per day · Live Background ₱499 · Live Photo Wall ₱2,500/day · Camera Bridge ₱500/day · Custom QR FREE. ⚠ Pabati/Kwento/Guest Stories: this banner says FREE, but live DB has them **active + PAID** (Kwento ₱299 · Pabati ₱1,299 · Stories ₱2,000) — **OPEN owner ruling** (free vs paid) |
>
> **VENDOR side — FINAL:** Free (Verified) ₱0 · Solo ₱999/28d · Pro ₱2,499/28d · **Enterprise ₱7,999/28d** (was ₱4,999 corpus / ₱7,499 live — ₱7,999 now canonical; annual TBD ~23% prepay) · **Custom from ₱8,999** (kept) · 0% commission · tokens flat ₱100 (100 free on verify · burn 1–3 to answer) · **`xxx.setnayan.com` subdomain ₱999/year** · Boosted/Sponsored Boost HELD (mechanism unbuilt).
>
> **🚨 DEPENDENCY:** "recurring billing for both" (the ₱999/yr subdomains, true vendor auto-renew, any renewal) needs a payment gateway + card-on-file + recurring scheduler + dunning — **none exists** (manual apply-then-pay only). Required build; until then "recurring" = manual re-charge.
...
Setnayan AI **₱499 one-time, per event** (🔁 owner-confirmed 2026-07-10 · ✅ live catalog `one_time`, PR #3022 · supersedes the retired per-USER subscription ₱499→₱799/28d owner-locked 2026-07-02) · Couple Website PRO ₱4,999 (umbrella · unlocks pro touches across Save the Date · RSVP · on-the-day · Editorial; reprice + owner-lock 2026-07-04, was ₱1,999) · Editorial PRO ₱3,499 (à-la-carte editorial authoring; also included in Couple Website PRO · new 2026-07-04) · Animated Monogram ₱1,999 · Pakanta ₱2,499 · 3D Plan ₱2,499 (priced · gate-pending) · Live Studio Mobile ₱1,299/day · Desktop ₱2,499/day (single-cam livestream FREE · YouTube via couple's OBS · device-repackaged 2026-07-08, was ₱3,499/day multicam) · Live Background ₱499 · Live Photo Wall ₱2,500/day · Pabati **FREE** (owner 2026-07-08 · was ₱1,299/day) · Guest Stories **FREE** (client-rendered · owner-locked free; the stale `PAPIC_ADDON_STORIES` ₱2,000 catalog row was deactivated 2026-06-30) · Kwento **FREE** (whole event · owner 2026-07-08 · was ₱299) · Camera Bridge ₱500/day (event-wide · round-up 2026-07-11, was ₱499) · Papic Unli ₱100/cam·day · Papic Ltd ₱30/cam·day (**capture caps ₱15,000 Unli / ₱9,000 Ltd · owner 2026-07-11, raised from ₱11,999/₱5,999**) · Unlock-all-Papic ₱15,000 (Unli) / ₱9,000 (Ltd) **⚠ now = the capture cap → reconcile (see § 2.1)** · Custom QR FREE. **No bundles** — Essentials/Complete removed 2026-06-29; the prior fixed "19-paid / SRP ₱48,483" framing is retired with them. SRP = live sum of the à-la-carte SKUs above. (Retired & no longer listed: RSVP/RSVP Pro/Event Website/Editorial Website standalone, Papic Guests, Papic 5 Seats, paid Stories line, Same-Day Edit, Patiktok, Thank You Video, Auto-Recap.)
...
| Setnayan AI | ₱499 one-time, per event | **Live** | Assisted planning (the AI planner — replaces "Setnayan Concierge" naming) · ✅ `SETNAYAN_AI` = ₱499/`one_time` (PR #3022); ₱799/28d sub retired |
...
| ~~Feature boost (per feature, 7 days)~~ | ~~4–100 tokens~~ | — | **❌ STRUCK 2026-07-10 — never built; retired by the v2.1 lock (DECISION_LOG:270 "no per-feature boosters"). Owner confirmed "we do not have boost." No token buys visibility; the only wired token sink is burn-to-answer-an-inquiry. PHP Boosted Ads/Sponsored Boost exist as seeded SKUs but the visibility mechanism is unbuilt.** |
...
|---|---|---|---|---|
| **Papic Ltd** (30 photos + 10×5s clips) | **₱30 / camera·day** | per-cam | ACTIVE · per-camera (≈ per-guest) · **5-cam min → ₱150** · **event cap ₱9,000/day** (owner-set 2026-07-11, raised from ₱5,999 · binds at 300 cams · count-capped → self-funding) | [0012_papic.md](0012_papic/0012_papic.md) |
| **Papic Unli** (unlimited · full-res Drive archive) | **₱100 / camera·day** | per-cam | ACTIVE · per-camera · **event cap ₱15,000/day** (owner-set 2026-07-11, raised from ₱11,999 · binds at 150 cams · ~2.4× Once — councils flagged, owner-accepted) | [0012_papic.md](0012_papic/0012_papic.md) |
| **Unlock all of Papic** (`PAPIC_UNLOCK` · one-click all-inclusive bundle) | **₱15,000/day (Unli-based)** · **₱9,000/day (Ltd-based)** | 1,500,000 / 900,000 | ACTIVE · **🚨 RECONCILE (owner call pending 2026-07-11):** the capture caps were raised to ₱15,000/₱9,000 = THIS bundle's price, so "capture + Photo Wall + Camera Bridge" now costs the SAME as capture alone → the unlock is now a **~₱3,000 DISCOUNT** vs à-la-carte (₱15,000 + ₱2,500 Wall + ₱500 Bridge = ₱18,000), no longer the at-list convenience bundle it was designed as. **Owner must choose:** (a) keep it as a discount bundle (fine, but it's now a genuine markdown), (b) reprice up to **₱18,000 (Unli) / ₱12,000 (Ltd)** to restore = capture-cap + add-ons at list, or (c) retire the separate unlock (capture cap already caps the day; add-ons bill on top). Package rows unchanged pending the call. | [0012_papic.md](0012_papic/0012_papic.md) |
...
| Live Photo Wall (`LIVE_WALL` · **under Papic**) | **₱2,500 / day** | 250,000 | ACTIVE · **round-up 2026-07-11 (was ₱2,499)** · repriced 2026-06-29 (₱1,000→₱1,499→₱2,499→₱2,500/day) | [0012_papic.md](0012_papic/0012_papic.md) |
...
| Papic Free tier (owner 2026-06-29 · allowance raised 2026-07-10) | **Gallery view + camera filters + first 5 cameras free** (10 photos + 3×5s clips each) | 0 | ACTIVE | [0012_papic.md](0012_papic/0012_papic.md) |
| **Keep Full-Res** (Papic album archive · revives retired `HIGH_RES_ARCHIVE`) | **₱999 / yr per 50 GB** (block, rounded up) | 99,900 /50GB | **NEW · owner-locked 2026-07-10** · annual, per-event, auto-renew · lapse → graceful web-copy fallback (never deleted) · **WEB-SOLD** (renewal email → setnayan.com checkout · avoids the 30% Apple/Google IAP cut — build rule: never sell in-app) · **archives on DEEP-COLD storage** (B2 / Hetzner / Glacier-class · retrieval-on-request ~hours · ~₱3–4/GB·yr — build rule: NOT hot R2, which erodes margin) · **charged ONLY when full-res is on OUR storage — Drive-synced originals = ₱0, no charge** · ~₱200/block real margin after 30%-equiv + 50% opex | [0012_papic.md](0012_papic/0012_papic.md) |
