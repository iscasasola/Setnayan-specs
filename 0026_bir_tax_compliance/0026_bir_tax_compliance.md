...
>
> This file is the **original `0026` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0026_bir_tax_compliance/0026_bir_tax_compliance.md
> git log --follow -- 0026_bir_tax_compliance/0026_bir_tax_compliance.md
> ```
>
