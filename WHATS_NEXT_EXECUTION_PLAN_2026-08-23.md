...
| ✅ **W4-WORDS · The words follow the occasion — DONE 2026-08-24** *(⭑ re-balance addition, § 0c of the prompts file)* | 1 PR [#4793](https://github.com/iscasasola/setnayan-platform/pull/4793), SERVED and verified in prod by the object: the **funeral** — the first SOLEMN event type (`register:'solemn'` in the terminology JSONB; no countdown, no save-the-date/editorial phase, no upsells, abuloy wording, its own checklist/roles/run-of-show/sample story). 🔑 Step 1 (threading the 16 types) was ALREADY S13 — the brief's "69 instances" was stale. Six coverage guards fired on the new type; each answered as a decision. Open owner calls: AI tier · Papic-at-wakes · a funeral-home taxonomy leaf. Full row: `DECISION_LOG.md` 2026-08-24 🕊️. | **data-only** (vocab + profile + intro + 7 category appends; no schema) |
