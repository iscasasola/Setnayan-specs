...
>
> This file is the **original `0034` iteration spec**, kept only for lineage. It has **drifted** from what actually shipped (prices, SKU names, retired features, flows) and **must not be used to answer "what does Setnayan do today."**
>
...
> ```
> git show 573a96c:0034_payments_and_cart/0034_payments_and_cart.md
> git log --follow -- 0034_payments_and_cart/0034_payments_and_cart.md
> ```
>
