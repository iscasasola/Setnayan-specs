...
| **S7** | **Sorting reaches the bottom tier only.** The couple's lens joins the shipped tail-tier re-rank; relationship / boosted / top-reviews never move by algorithm. | opus · **xhigh** | — | It touches an **owner-locked commercial ladder** where paid placement lives. Getting the boundary wrong moves money. |
