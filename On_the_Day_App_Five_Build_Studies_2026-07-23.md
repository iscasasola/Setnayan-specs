...
*Scribe note: per the relaxed sync mandate, this is a new dated corpus doc; a DECISION_LOG row should be appended when the owner signs off § 6.2 items. No iteration-stub bodies were touched.*
